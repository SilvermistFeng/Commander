...
- TripRequest: What the user asks for (city, dates, budget)
- Activity: A single thing to do (restaurant, museum, park)
- DayPlan: One day's worth of activities, in order
...
class TripRequest(BaseModel):
    ...
    to Rome for 4 days with a budget of £800. The optimiser
    takes this and builds the best possible itinerary.
    """
